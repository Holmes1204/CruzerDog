...
namespace Interpolate
{
  ...
  /*!
   * Cubic bezier interpolation first order derivative between y0 and yf.  x is between 0 and
   * 1
   */
  template <typename y_t, typename x_t>
  ...
  /*!
   * Cubic bezier interpolation second order derivative between y0 and yf.
   * x is between 0 and1
   */
  template <typename y_t, typename x_t>
