#include <Robot/LegKinematics_unitree.h>
// functions with basic C++ interface, generated by Matlab
void LegKinematics::autoFunc_fk_derive(const double in1[3], const double in2[3], const double in3[5], double p_bf[3])
{
    double p_bf_tmp;
    double t2;
    double t3;
...
void LegKinematics::autoFunc_d_fk_dq(const double in1[3], const double in2[3], const double in3[5], double jacobian[9])
{
...
void LegKinematics::autoFunc_d_fk_dc(const double in1[3], const double in2[3], const double in3[5], double d_fk_dc[9])
{
    double t2;
    double t3;
    double t4;
...
void LegKinematics::autoFunc_dJ_dq(const double in1[3], const double in2[3], const double in3[5], double dJ_dq[27])
{
    double t10;
    double t13;
    double t17;
...
void LegKinematics::autoFunc_dJ_dpho(const double in1[3], const double[3], const double[5], double dJ_dpho[27])
{
    double t11;
    double t12;
    double t13;
